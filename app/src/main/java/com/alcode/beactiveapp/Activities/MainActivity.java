...
import com.alcode.beactiveapp.Adapters.DummyAdapter;
import com.alcode.beactiveapp.Models.Item;
import com.alcode.beactiveapp.R;
import com.alcode.beactiveapp.Utility.MyPreferences;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(MyPreferences.isFirst(getApplicationContext()))
            showHelp();
        ...
        mAdapter = new DummyAdapter(getApplicationContext());
    ...
    private void showHelp() {
        ...
        intent.setClass(getApplicationContext(),AppTutorial.class);
